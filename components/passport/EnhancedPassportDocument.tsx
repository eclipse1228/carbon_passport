              ...
              <div className="text-center lg:text-left">
                <div className="flex flex-col lg:flex-row items-center gap-6">
                  <Avatar className="h-24 w-24 border-4 border-white shadow-lg">
                    {data.photoUrl ? (
                      <AvatarImage src={data.photoUrl} alt={data.travelerName} />
                    ) : (
                      <AvatarFallback className="bg-white text-green-600 text-xl font-bold">
                        {getUserInitials(data.travelerName)}
                      </AvatarFallback>
                    )}
                  </Avatar>
                  <div className="space-y-2">
                    <h1 className="text-3xl font-bold">{data.travelerName}</h1>
            ...
            {data.routes.length > 0 ? (
              <div className="space-y-4">
                {data.routes.map((route, index) => {
                  ...
                  return (
                    <Card key={route.id} className="border-l-4 border-l-green-500 bg-gradient-to-r from-green-50 to-white">
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          <Badge variant="outline" className={`${getTransportColor(route.transportMode)} text-white border-none`}>
                            <IconComponent className="h-3 w-3 mr-1" />
                            {getTransportLabel(route.transportMode)}
                          </Badge>
                        </div>
